...
<div>
  ...
  <div>
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-bold text-gray-900">Inventarios Registrados</h3>
    ...
    @foreach ($inventoriesByArea as $area => $inventories)
      <h4 class="text-md mb-2 mt-6 font-semibold uppercase text-gray-800">Área:
        {{ \App\Models\Area::find($area)->name }}</h4>
        ...
        <table class="min-w-full rounded-lg border border-gray-200 bg-white shadow-lg">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th class="px-4 py-2 text-center text-xs font-medium uppercase tracking-wider text-gray-700">Tipo de
                Movimiento</th>
